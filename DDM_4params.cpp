...
// [[Rcpp::export]]
List DDM_4params(double v, double a, double ter, NumericVector CC, double z, int ntrials = 1000, double s = 1, double dt = 0.01) { 
  ...
  for (int i = 0; i < ntrials; i++) {
    ...
    int acc = 0;
    double evidence = z*a; // 0; // add starting point here
    double t = 0;
    int t_idx = 0;
